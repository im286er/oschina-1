...
import com.liang.oschina.ui.adapters.tweet_adapters.MyTweet_LVAdapter;
 ...
 */
public class MyTweet_Fragment extends Fragment {
    private View mLayout;
    private ListView mListView ;
    private MyTweet_LVAdapter adapter ;
    private ImageView mEmptyView ;
    private List<Tweet_List> list = null ;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle) {
        mLayout = inflater.inflate(R.layout.tweet_myfragment,container,false);
        mListView = (ListView) mLayout.findViewById(R.id.tweet_my_listView);
        mEmptyView = (ImageView) mLayout.findViewById(R.id.tweet_my_emptyImg);
        initView();
    ...
    private void initView() {
        list = new ArrayList<>();
        adapter = new MyTweet_LVAdapter(list);
    ...
    private void getDataFromNet() {
        ...
        String url = Constant.tweet_path_my+1;
